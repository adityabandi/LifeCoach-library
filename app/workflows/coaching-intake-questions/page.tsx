...
export const metadata = generateSEO({
  title: 'Coaching Intake Questions & Red Flags (Free Forms)',
  ...
  keywords: ['coaching intake forms', 'coaching questionnaire', 'client intake', 'intake process', 'coaching assessment'],
