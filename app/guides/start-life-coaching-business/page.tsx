    ...
    <div className="min-h-screen bg-white">
        ...
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500">
          <ol className="flex items-center space-x-2">
            ...
            <li aria-current="page">
              <span>Start Life Coaching Business</span>
            </li>
          </ol>
        </nav>
      </div>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="prose-custom">
          ...
          <h2>Decide whether to get certified</h2>
          <p>
          ...
          <h2>Offer strategic packages and pricing</h2>
          <p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600 text-sm mb-3">
                Streamlined system for onboarding new coaching clients with templates and workflows.
              </p>
